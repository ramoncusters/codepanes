  ...
  constructor(
    ...
    this.instructionsText = new TextRenderable(renderer, {
      content: [
        ...
        "",
        "Complete example:",
        "  { \"theme\": \"dracula\", \"shell\": \"sh\",",
        "    \"globalKeybindings\": {",
        "      \"Global\": { \"C\": { \"name\": \"Edit config\", \"action\": \"edit-config\" } },",
        "      \"Worktrees\": {",
        "        \"spacebar\": { \"name\": \"Select worktrees\", \"action\": \"select-worktrees\" },",
        "        \"o\": { \"name\": \"Open Neovim\", \"action\": \"run-command\",",
        "               \"command\": \"nvim {{worktreeDir}}\", \"target\": \"external\" }",
        "      },",
        "      \"Lazygit\": {}, \"Collaboration\": {}, \"Actions\": {}",
        "    },",
        "    \"projects\": { \"my-project\": {",
        "      \"shell\": \"zsh\",",
        "      \"defaultWorktree\": \"feature/foo\",",
        "      \"keybindings\": { \"Worktrees\": {}, \"Lazygit\": {}, \"Actions\": {} },",
        ...
        "  Worktrees, Lazygit, and Actions contain bindings specific to that tab.",
        "",
        "projects",
        ...
        "  defaultWorktree selects the initial worktree by branch, name, or path.",
        "  If omitted, CodePanes selects the main branch, then the first worktree.",
        ...
        "  edit-config, switch-theme, run-action, stop-action, stop-actions",
        "",
        "Project names are the repository root directory names.",
        "Use {{worktreeDir}} and {{worktreeName}} in run-command bindings.",
        "",
